...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupSettingsControls() {
        ...
        btnApplySettings.setOnClickListener {
            ...
            val newMode = if (selectedDarkMode) AppCompatDelegate.MODE_NIGHT_YES
            ...
            val summary = buildString {
                ...
                append(alias)
                append(" • ")
                append(spinnerVisibility.selectedItem.toString())
                append(" • ")
    ...
    private fun observeState() {
        ...
        // Single collector for P2P state — eliminates the double-update from the old code.
        lifecycleScope.launch {
